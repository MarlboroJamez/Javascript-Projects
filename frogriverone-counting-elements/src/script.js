function onSubmit(){
  var X = parseInt(document.getElementById("value-x").value);
   var A = parseInt(document.getElementById('value-a').value);
   let myFunc = num => Number(num);
   var intArr = Array.from(String(A), myFunc);
  
    document.getElementById("output").innerHTML = "Seconds: " + solution(X,intArr);
}
